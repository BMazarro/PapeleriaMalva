...
Public Class Proveedores
    ...
    Private Sub Proveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            Conexion.Open()
            cadena = "SELECT COUNT(*) FROM PROVEEDORES"
    ...
    Private Sub CargarEnPosicion(ByVal pos As Integer)
        Try
            Conexion.Open()
            cadena = "SELECT * FROM PROVEEDORES ORDER BY CODPROV"
            consulta = New SqlCommand(cadena, Conexion)
    ...
    Private Sub MostrarDatos()
        Dim tuf As Date
        Try
            tbcodigo.Text = Mireader("CODPROV").ToString
    ...
    Private Sub bborrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bborrar.Click
        ...
        If res = Windows.Forms.DialogResult.Yes Then
            Try
                Conexion.Open()
                cadena = "delete from Proveedores where codprov = '" & tbcodigo.Text & "';"
                consulta = New SqlCommand(cadena, Conexion)
    ...
    Private Sub bbuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bbuscar.Click
        Dim cod As String
        cod = InputBox("Introduzca el codigo del proveedor", "Buscar")
        Try
            Conexion.Open()
            cadena = "select * from Proveedores where codprov='" & cod & "';"
        ...
        If IsNumeric(tbcodigo.Text) And Not tbnombre.Text.Equals("") Then
            If (opcion = 1) Then
                Try
                    ...
                    If tbfechauc.Text = "" Then
                        cadena = "Insert into Proveedores(codprov, nombre, nif, direccion, cp, localidad, provincia, telefono, email, fechaultcompra, banco, cuenta, observaciones)" &
            ...
            ElseIf (opcion = 2) Then
                Try
                    Conexion.Open()
                    If (tbfechauc.Text = "") Then
                        cadena = "update Proveedores set codprov=" & "'" & tbcodigo.Text & "'" & "," &
            ...
            Habilitar()
        Else
            MsgBox("El código del proveedor y el nombre son obligatorios")
            Habilitar()
            Conexion.Close()
        End If
    End Sub
