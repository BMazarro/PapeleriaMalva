...
Public Class Productos
    ...
    Private Sub Productos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            ' Leemos el datareader
            While Mireader.Read()
                ' Mostramos los datos de los articulos
    ...
    Public Sub MostrarDatosArticulos()
        coda = Mireader("codart").ToString
        desa = Mireader("descripcion").ToString
        stocka = Mireader("stock").ToString
        pvpa = Mireader("pvp").ToString

        dgarticulos.Rows.Add(coda, desa, stocka, pvpa)
    End Sub
    ...
    Private Sub dgarticulos_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgarticulos.CellClick
        codproducto = dgarticulos.Item(0, dgarticulos.CurrentRow.Index).Value.ToString
        descripcionart = dgarticulos.Item(1, dgarticulos.CurrentRow.Index).Value.ToString
        pvpart = CDbl(dgarticulos.Item(3, dgarticulos.CurrentRow.Index).Value)
